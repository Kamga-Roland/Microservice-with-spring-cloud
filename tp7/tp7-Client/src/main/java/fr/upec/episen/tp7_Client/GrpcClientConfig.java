...
import fr.upec.episen.tp7_server.ProductServiceGrpc;
...
public class GrpcClientConfig {
    ...
    public ProductServiceBlockingStub productServiceClient(DiscoveryClient discoveryClient) {
        ...
        List<ServiceInstance> instances = discoveryClient.getInstances("tp7-Serveur");

        if (instances == null || instances.isEmpty()) {
            throw new IllegalStateException("No instances found in eureka for service: tp7-Serveur");
        }
