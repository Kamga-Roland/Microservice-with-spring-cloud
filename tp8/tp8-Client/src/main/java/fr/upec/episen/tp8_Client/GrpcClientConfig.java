...
public class GrpcClientConfig {
    ...
    public ProductServiceBlockingStub productServiceClient(DiscoveryClient discoveryClient) {
        ...
        List<ServiceInstance> instances = discoveryClient.getInstances("tp8-Serveur");

        if (instances == null || instances.isEmpty()) {
            throw new IllegalStateException("No instances found in eureka for service: tp8-Serveur");
        }
