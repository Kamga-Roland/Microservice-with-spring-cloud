...
import fr.upec.episen.tp9_server.ProductServiceGrpc.ProductServiceImplBase;
...
import fr.upec.episen.tp9_server.ProductServiceOuterClass.ListProductsRequest;
import fr.upec.episen.tp9_server.ProductServiceOuterClass.ListProductsResponse;
import fr.upec.episen.tp9_stock.StockRequest;
import fr.upec.episen.tp9_stock.StockResponse;
import fr.upec.episen.tp9_stock.StockServiceGrpc;
    ...
    public void getProduct(GetProductRequest request, StreamObserver<GetProductResponse> responseObserver) {
        ...
        if (product != null) {
            ...
            try {
                ...
                logger.info("Appel gRPC via Eureka vers tp9-stock pour le produit " + productId);
                ...
                logger.error("Échec de la communication gRPC avec tp9-stock : " + e.getMessage());
            }
