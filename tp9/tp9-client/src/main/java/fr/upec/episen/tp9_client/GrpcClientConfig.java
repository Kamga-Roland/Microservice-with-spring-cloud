...
import fr.upec.episen.tp9_server.ProductServiceGrpc;
...
public class GrpcClientConfig {
    ...
    public ProductServiceGrpc.ProductServiceBlockingStub productServiceStub(DiscoveryClient discoveryClient) {
        ...
        List<ServiceInstance> instances = discoveryClient.getInstances("tp9-server");
        
        if (instances == null || instances.isEmpty()) {
            throw new IllegalStateException("Aucune instance du service 'tp9-server' n'a été trouvée dans Eureka !");
        }
