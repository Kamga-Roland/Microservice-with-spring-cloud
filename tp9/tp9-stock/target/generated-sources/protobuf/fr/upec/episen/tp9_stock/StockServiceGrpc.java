...
public final class StockServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "fr.upec.episen.tp9_stock.StockService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<fr.upec.episen.tp9_stock.StockRequest,
      fr.upec.episen.tp9_stock.StockResponse> getGetStockByProductIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetStockByProductId",
      requestType = fr.upec.episen.tp9_stock.StockRequest.class,
      responseType = fr.upec.episen.tp9_stock.StockResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<fr.upec.episen.tp9_stock.StockRequest,
      fr.upec.episen.tp9_stock.StockResponse> getGetStockByProductIdMethod() {
    io.grpc.MethodDescriptor<fr.upec.episen.tp9_stock.StockRequest, fr.upec.episen.tp9_stock.StockResponse> getGetStockByProductIdMethod;
      ...
      synchronized (StockServiceGrpc.class) {
        if ((getGetStockByProductIdMethod = StockServiceGrpc.getGetStockByProductIdMethod) == null) {
          StockServiceGrpc.getGetStockByProductIdMethod = getGetStockByProductIdMethod =
              io.grpc.MethodDescriptor.<fr.upec.episen.tp9_stock.StockRequest, fr.upec.episen.tp9_stock.StockResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetStockByProductId"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fr.upec.episen.tp9_stock.StockRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fr.upec.episen.tp9_stock.StockResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getStockByProductId(fr.upec.episen.tp9_stock.StockRequest request,
        io.grpc.stub.StreamObserver<fr.upec.episen.tp9_stock.StockResponse> responseObserver) {
  ...
  public static final class StockServiceStub
    ...
    /**
     */
    public void getStockByProductId(fr.upec.episen.tp9_stock.StockRequest request,
        io.grpc.stub.StreamObserver<fr.upec.episen.tp9_stock.StockResponse> responseObserver) {
  ...
  public static final class StockServiceBlockingV2Stub
    ...
    /**
     */
    public fr.upec.episen.tp9_stock.StockResponse getStockByProductId(fr.upec.episen.tp9_stock.StockRequest request) throws io.grpc.StatusException {
  ...
  public static final class StockServiceBlockingStub
    ...
    /**
     */
    public fr.upec.episen.tp9_stock.StockResponse getStockByProductId(fr.upec.episen.tp9_stock.StockRequest request) {
  ...
  public static final class StockServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<fr.upec.episen.tp9_stock.StockResponse> getStockByProductId(
        fr.upec.episen.tp9_stock.StockRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_STOCK_BY_PRODUCT_ID:
          serviceImpl.getStockByProductId((fr.upec.episen.tp9_stock.StockRequest) request,
              (io.grpc.stub.StreamObserver<fr.upec.episen.tp9_stock.StockResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              fr.upec.episen.tp9_stock.StockRequest,
              fr.upec.episen.tp9_stock.StockResponse>(
  ...
  private static abstract class StockServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return fr.upec.episen.tp9_stock.Stock.getDescriptor();
    }
