...
import fr.upec.episen.tp8_server.ProductServiceGrpc.ProductServiceBlockingStub;

@SpringBootApplication
@EnableDiscoveryClient // Permet au client de communiquer avec l'annuaire
public class Tp8ClientApplication implements CommandLineRunner {
	protected Logger logger = LoggerFactory.getLogger(Tp8ClientApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(Tp8ClientApplication.class, args);
	}
